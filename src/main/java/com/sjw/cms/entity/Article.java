...
public class Article implements Serializable {
	...
	private Integer deleted;//删除状态  0：整除  1：逻辑删除
	private Date created;//文章发布时间
	private Date updated;//文章修改时间
	private String summary;//文章摘要
	private Integer plnum;//文章评论数量
	...
	public Article(Integer id, String title, String content, String picture, Integer channelId, Integer categoryId,
			...
			String summary, Channel channel, Category category, User user) {
		super();
		this.id = id;
		this.title = title;
		this.content = content;
	...
	public String toString() {
		return "Article [id=" + id + ", title=" + title + ", content=" + content + ", picture=" + picture
				...
				+ updated + ", summary=" + summary + ", channel=" + channel + ", category=" + category + ", user="
				+ user + "]";
	}
